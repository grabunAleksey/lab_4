...
public class GraphicsDisplay extends JPanel {
    ...
    protected void paintAxis(Graphics2D canvas) {
        ...
        if (minY<=0.0 && maxY>=0.0) {
            ...
            String originLabel1 = "1";
            Rectangle2D originBounds1 = axisFont.getStringBounds(originLabel, context);
            Point2D.Double originLabelPos1 = xyToPoint(2, 0);
            // Вывести надпись в точке с вычисленными координатами
            ...
            canvas.drawString(originLabel1, (float)(originLabelPos1.getX() -
                    originBounds1.getWidth() - 10), (float)(originLabelPos1.getY() + originBounds1.getY() + 40));

            canvas.setColor(Color.BLACK); // Устанавливаем цвет линии

// Предположим, что у вас есть метод xyToPoint, который преобразует координаты графика в координаты экрана
            Point2D.Double startPoint = xyToPoint(1, -1);
            Point2D.Double endPoint = xyToPoint(1, 0);

// Рисуем линию от (3, 0) до (4, 4)
            canvas.drawLine((int) startPoint.getX(), (int) startPoint.getY(), (int) endPoint.getX(), (int) endPoint.getY());
        }
    }
